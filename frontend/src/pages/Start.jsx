...
function Start() {
  ...
  return (
    <div>
      {
        loading ? <Loading /> : <div>
          <div className={`bg-cover h-screen w-full flex flex-col justify-between
          bg-[url(https://plus.unsplash.com/premium_vector-1721722789631-84eed6cc72ef?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] `}>
            <img
              src={Uberpng} alt=''
              className='w-30'
            />
